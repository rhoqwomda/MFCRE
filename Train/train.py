...
def get_args():
    ...
    parser.add_option('--temp_param', dest='temp_param', default=0.9, type='float',
                      help='temperature parameter of SWFC loss')
    parser.add_option('--focus_param', dest='focus_param', default=3.0, type='float',
